...
cwpdgefa	Gaussian elimination to obtain the LU factorization of a matrix.
cwpdgeco	Gaussian elimination to obtain the LU factorization and condition
		number of a matrix.
cwpdgesl	Solve linear system Ax = b or A'x = b after LU factorization.

*****************************************************************************
Function Prototypes:
void cwpdgefa (double **a, int n, int *ipvt, int *info);
void cwpdgeco (double **a, int n, int *ipvt, double *rcond, double *z);
void cwpdgesl (double **a, int n, int *ipvt, double *b, int job);
...
to solve linear systems of equations via cwpdgesl.
...
void
cwpdgefa (double **a, int n, int *ipvt, int *info)
/*****************************************************************************
...
void
cwpdgeco (double **a, int n, int *ipvt, double *rcond, double *z)
/*****************************************************************************
...
void
cwpdgesl (double **a, int n, int *ipvt, double *b, int job)
/*****************************************************************************
